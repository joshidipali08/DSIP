...
def cross_correlation(signal1, signal2): # Compute the cross-correlation
...
cross_corr = cross_correlation(signal1, signal2) # Compute the autocorrelation
...
plt.subplot(2, 1, 1)
plt.stem(cross_corr)
plt.title('Cross-correlation dipali joshi_013')
plt.xlabel('Time Lag')
plt.ylabel('Magnitude')

plt.subplot(2, 1, 2)
plt.stem(auto_corr)
plt.title('Autocorrelation dipali joshi_013')
plt.xlabel('Time Lag')
plt.ylabel('Magnitude')
